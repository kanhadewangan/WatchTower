// Footer component for Hero section
const Footer = () => {
  return (
    <footer className=" text-gray-600 py-12 bg-linear-gradient(135deg, #F8FAFC 0%, #DBE6E1 50%, #E6FFFA 100%)">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div className="col-span-1">
            <h3 className="text-black text-xl font-bold mb-4">WatchTower</h3>
            <p className="text-sm">
              Building better solutions for a better tomorrow.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
          <p>&copy; 2026 WatchTower. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
