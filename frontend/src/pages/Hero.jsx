  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="px-5 py-2 text-sm font-bold text-amber-500 border border-amber-500/50 rounded-lg hover:bg-amber-500/10 transition-all HeadingFont"
      >
        Start Watching
      </motion.button>
    </motion.nav>
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white selection:bg-amber-500/30 overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        >
          <motion.h1 variants={itemVariants} className="text-5xl md:text-7xl font-extrabold HeadingFont leading-tight mb-6">
            Your Website Is <br />
            Being <span className="text-gradient">Watched.</span>
          </motion.h1>

          <motion.p variants={itemVariants} className="text-lg md:text-xl text-gray-400 BodyFont max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <motion.div
            ...
            className="grid grid-cols-1 md:grid-cols-3 gap-8 p-8 bg-[#111118] border border-white/5 rounded-3xl shadow-2xl relative overflow-hidden"
          >
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-amber-500 HeadingFont mb-1">
                <Counter value="99.98%" />
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div
              ...
              className="relative z-10 p-2 bg-[#1a1a24] border border-white/10 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.5)]"
            >
              <div className="flex items-center gap-1.5 px-4 py-3 border-b border-white/5 bg-white/5 rounded-t-xl">
              ...
              <div className="aspect-video bg-[#0a0a0f] relative overflow-hidden flex items-center justify-center group">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-full max-w-3xl flex flex-col gap-6 p-8">
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      {[1, 2, 3, 4].map((i) => (
                        <div key={i} className="h-32 bg-white/5 border border-white/5 rounded-xl flex flex-col p-4 gap-2">
                          <div className="h-3 w-12 bg-white/10 rounded-full" />
                          <div className="h-6 w-16 bg-amber-500/40 rounded-lg mt-auto" />
                        </div>
                      ))}
                    </div>
                    <div className="h-64 bg-white/5 border border-white/5 rounded-xl overflow-hidden relative">
                      <div className="absolute inset-0 flex items-end px-12 gap-1 pb-4">
                        {[...Array(30)].map((_, i) => (
      ...
      <section id="features" className="py-24 px-6 relative overflow-hidden">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold HeadingFont mb-4">Command-Level Visibility <br className="hidden md:block" /> Over Every Request</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-8 bg-[#1a1a24] border border-white/5 rounded-3xl transition-all group overflow-hidden relative"
              >
                ...
                <h3 className="text-xl font-bold HeadingFont mb-3 group-hover:text-amber-500 transition-colors">{f.title}</h3>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-24 px-6 relative bg-[#0a0a0f]">
        <div className="max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-5xl font-bold HeadingFont mb-4">No Surprises. Just Clarity.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="p-8 bg-[#111118] border border-white/5 rounded-3xl flex flex-col"
            >
              <div className="mb-8">
                <h3 className="text-xl font-bold HeadingFont mb-2">Free</h3>
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-bold HeadingFont">$0</span>
              ...
              <motion.button
                ...
                className="w-full py-4 px-6 border border-white/10 rounded-xl hover:bg-white/5 transition-colors HeadingFont font-bold"
              >
                Get Started Free
              </motion.button>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-8 bg-[#1a1a24] border-2 border-amber-500 rounded-3xl flex flex-col relative"
            >
              <div className="absolute top-0 right-8 -translate-y-1/2 px-4 py-1 bg-amber-500 text-black text-[10px] font-black uppercase tracking-widest rounded-full">
                Most Popular
              </div>
              <div className="mb-8">
                <h3 className="text-xl font-bold HeadingFont mb-2 text-amber-500">Pro</h3>
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-bold HeadingFont">$9</span>
                  <span className="text-gray-500 text-sm">/mo</span>
                </div>
              </div>
              <ul className="space-y-4 mb-10 flex-1">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => navigate("/signup")}
                className="w-full py-4 px-6 bg-amber-500 text-black rounded-xl font-bold HeadingFont shadow-xl"
              >
                Start Pro Trial
              </motion.button>
            </motion.div>
            ...
            >
              <div className="mb-8">
                <h3 className="text-xl font-bold HeadingFont mb-2">Enterprise</h3>
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-bold HeadingFont">$20</span>
                  <span className="text-gray-500 text-sm">/mo</span>
                </div>
              </div>
              <ul className="space-y-4 mb-10 flex-1">
      ...
      <footer className="py-16 px-6 border-t border-white/5 bg-[#0a0a0f]">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
            ...
            <div className="flex gap-8 text-sm text-gray-400 BodyFont">
          ...
          <div className="text-center md:text-left pt-8 border-t border-white/5 text-gray-600 text-[10px] uppercase tracking-[0.2em] BodyFont">
